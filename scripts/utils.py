...
def teacher(e1, e2, num_paths, env, path = None):
	...
	print_status('BFS found paths:', len(res_path_lists))
	...
	print_status(res_entity_lists_new)
	print_status(res_path_lists_new)
...
if __name__ == '__main__':
	print_status(prob_norm(np.array([1,1,1])))
